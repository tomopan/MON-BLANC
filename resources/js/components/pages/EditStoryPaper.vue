<template>
    <div class="cont">
        ...
        <!-- モバイル表示のエピソード番号 -->
        <div class="m_episode_num">第{{ episodeOrder }}話</div>
        <v-row>
            <!-- 小説入力 -->
        ...
        <!-- モバイル表示のカウント -->
        <div class="m_count">{{ charaCount }}/5000文字</div>
        <!-- モバイル表示のボタン -->
        <div class="m_buttons">
            <!-- 一時保存ボタン -->
            <div class="m_btn">
                <v-btn color="#c9eff5" @click="editPaper">保存</v-btn>
            </div>
            <!-- ヒント -->
            <hint />
            <!-- 戻るボタン -->
...
export default {
    ...
    methods: {
        ...
        editPaper: function() {
            //5000字以上だったらアラート表示
            if (
                document.getElementById("story_text_input").innerHTML.length >
                5000
            )
