...
export default {
    ...
    methods: {
        ...
        saveNovelTitle:function(){
            axios
            .post("api/post/noveltitle/"+this.$route.params.hero_id,this.novelTitlePost)
            .then(res => {
                console.log(res.data);
                console.log(res.data.id);

                this.$router.push({name:'Write',params:{hero_id:this.$route.params.hero_id,novel_id:res.data.id}});
            })
            .catch(err => {
