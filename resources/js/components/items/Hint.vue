<template>
  <div>
    ...
    <v-img :src="'/img/write-page/hint.png'" class="close" alt="hint" @click="dialog = !dialog" />
    <!-- </router-link> -->
    <div id="overlay" v-show="dialog">
      <div id="content">
        <div class="write">
          ...
          <textarea name id cols="30" rows="2" v-model="answers.q_1"></textarea>
          <p>この主人公の最後はハッピーエンド？バッドエンド？</p>
          <textarea name id cols="30" rows="2" v-model="answers.q_2"></textarea>
          <p>その主人公は今、どういう心情？もしくは状況？</p>
          <textarea name id cols="30" rows="2" v-model="answers.q_3"></textarea>
          <p>主人公は今どこにいる？どんな風景が見えている？</p>
          <textarea name id cols="30" rows="2" v-model="answers.q_4"></textarea>
          <p>この小説がもし手紙だとしたら、誰に向けて書く？</p>
          <textarea name id cols="30" rows="2" v-model="answers.q_5"></textarea>
          <p></p>
          <button style="border:solid 2px #000" @click="saveAnswers">&nbsp;保存&nbsp;</button>
